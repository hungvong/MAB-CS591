...
prices = (arm1.p_list[arm1.l_max] * 100., arm2.p_list[arm2.l_max] * 100., arm3.p_list[arm3.l_max] * 100., arm4.p_list[arm4.l_max] * 100., arm5.p_list[arm5.l_max] * 100.)
...
prices = (arm1.p_list[0] * 100., arm2.p_list[0] * 100., arm3.p_list[0] * 100., arm4.p_list[0] * 100., arm5.p_list[0] * 100.)
